...
default_dag_args = {
    ...
    'start_date':datetime(2020, 5, 7, 10, 0)
}
...
export_data_groupby = BigQueryToCloudStorageOperator(
                        ...
                        destination_cloud_storage_uris='gs://{}/archivo_final.csv'.format(params['BUCKET_ID']),
                        export_format='CSV',
                        dag = dag
                )
...
delete_bq_dataset = bash_operator.BashOperator(
                    ...
                    bash_command='bq rm -r -f %s' % bq_recent_questions_table_id,
...
start >> (list_gcs_to_bq) >> execute_bq_sql >> export_data_groupby >>  upload_files_to_sftp >> end